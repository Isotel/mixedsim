...
<layer number="100" name="ngspice-init" color="7" fill="1" visible="yes" active="yes"/>
...
<pad name="4" x="-1.27" y="0" drill="0.8128" diameter="1.397" shape="square"/>
<text x="-11.43" y="2.54" size="1.27" layer="21">SPICEOBJECT</text>
<pad name="5" x="1.27" y="0" drill="0.8128" diameter="1.397" shape="square"/>
<pad name="6" x="3.81" y="0" drill="0.8128" diameter="1.397" shape="square"/>
<pad name="7" x="6.35" y="0" drill="0.8128" diameter="1.397" shape="square"/>
<pad name="8" x="8.89" y="0" drill="0.8128" diameter="1.397" shape="square"/>
</package>
</packages>
<symbols>
<symbol name="PORT">
...
<pin name="D0#" x="10.16" y="7.62" length="middle" direction="out" rot="R180"/>
<pin name="D1#" x="10.16" y="5.08" length="middle" direction="out" rot="R180"/>
<pin name="D2#" x="10.16" y="2.54" length="middle" direction="out" rot="R180"/>
<pin name="D3#" x="10.16" y="0" length="middle" direction="out" rot="R180"/>
<pin name="D4#" x="10.16" y="-2.54" length="middle" direction="out" rot="R180"/>
<pin name="D5#" x="10.16" y="-5.08" length="middle" direction="out" rot="R180"/>
<pin name="D6#" x="10.16" y="-7.62" length="middle" direction="out" rot="R180"/>
<pin name="D7#" x="10.16" y="-10.16" length="middle" direction="out" rot="R180"/>
</symbol>
</symbols>
<devicesets>
...
<deviceset name="SPICE-PARAM" prefix="SPARAM" uservalue="yes">
...
<deviceset name="DSOURCE8" prefix="A">
<description>The digital source provides for straightforward descriptions of digital signal vectors in a tabular format. 
The model reads input from the input file and, at the times specified in the file, generates the inputs along with the strengths listed.
&lt;p&gt;
...
&lt;code&gt;
0.0000      Uu  Uu  Uu&lt;br&gt;
1.234e-9   0s   1s  0z&lt;br&gt;
1.376e-9   1s   0s  0z&lt;br&gt;
2.5e-7       0s   0s  0z&lt;br&gt;
&lt;/code&gt;
&lt;br&gt;
...
particular prevents nuisance errors on the part of the simulator).</description>
<gates>
<gate name="G$1" symbol="SOURCE8" x="0" y="0"/>
</gates>
<devices>
<device name="" package="SPICE8">
<connects>
...
<technologies>
<technology name="">
<attribute name="SPICE_MODEL" value=".model &gt;VALUE d_source(input_file input_load)" constant="no"/>
<attribute name="SPICE_PORTS" value="[ 1 2 3 4 5 6 7 8 ]" constant="no"/>
<attribute name="SP_INPUT_FILE" value="&quot;input.txt&quot;" constant="no"/>
<attribute name="SP_INPUT_LOAD" value="1e-12" constant="no"/>
</technology>
</technologies>
</device>
</devices>
...
<attributes>
<attribute name="AUTHOR" value="Uros Platise"/>
<attribute name="TITLE" value="PRS Sine Generator"/>
</attributes>
<variantdefs>
</variantdefs>
<classes>
...
<modules>
<module name="PRSGEN8" prefix="" dx="30.48" dy="20.32">
<ports>
<port name="CLK" side="left" coord="5.08" direction="in"/>
<port name="RST" side="left" coord="0" direction="in"/>
<port name="CMP0" side="bottom" coord="-7.62" direction="in"/>
<port name="CMP1" side="bottom" coord="-5.08" direction="in"/>
<port name="CMP2" side="bottom" coord="-2.54" direction="in"/>
<port name="CMP3" side="bottom" coord="0" direction="in"/>
<port name="CMP4" side="bottom" coord="2.54" direction="in"/>
<port name="CMP5" side="bottom" coord="5.08" direction="in"/>
<port name="CMP6" side="bottom" coord="7.62" direction="in"/>
<port name="CMP7" side="bottom" coord="10.16" direction="in"/>
<port name="OUT" side="right" coord="5.08" direction="out"/>
</ports>
<variantdefs>
</variantdefs>
<parts>
<part name="XPIN1" library="ngspice" deviceset="SPICE-XPORT" device="" value="CLK"/>
<part name="XPIN2" library="ngspice" deviceset="SPICE-XPORT" device="" value="RST"/>
<part name="XPIN3" library="ngspice" deviceset="SPICE-XPORT" device="" value="CMP0"/>
<part name="XPIN4" library="ngspice" deviceset="SPICE-XPORT" device="" value="CMP1"/>
<part name="XPIN5" library="ngspice" deviceset="SPICE-XPORT" device="" value="CMP2"/>
<part name="XPIN6" library="ngspice" deviceset="SPICE-XPORT" device="" value="CMP3"/>
<part name="XPIN7" library="ngspice" deviceset="SPICE-XPORT" device="" value="CMP4"/>
<part name="XPIN8" library="ngspice" deviceset="SPICE-XPORT" device="" value="CMP5"/>
<part name="XPIN9" library="ngspice" deviceset="SPICE-XPORT" device="" value="CMP6"/>
<part name="XPIN10" library="ngspice" deviceset="SPICE-XPORT" device="" value="CMP7"/>
<part name="XPIN11" library="ngspice" deviceset="SPICE-XPORT" device="" value="OUT"/>
</parts>
<sheets>
<sheet>
<plain>
<text x="17.78" y="63.5" size="1.778" layer="110">.include ../prsgen8_ngspice.mod</text>
</plain>
<instances>
<instance part="XPIN1" gate="." x="17.78" y="58.42"/>
<instance part="XPIN2" gate="." x="17.78" y="53.34"/>
<instance part="XPIN3" gate="." x="17.78" y="48.26"/>
<instance part="XPIN4" gate="." x="17.78" y="45.72"/>
<instance part="XPIN5" gate="." x="17.78" y="43.18"/>
<instance part="XPIN6" gate="." x="17.78" y="40.64"/>
<instance part="XPIN7" gate="." x="17.78" y="38.1"/>
<instance part="XPIN8" gate="." x="17.78" y="35.56"/>
<instance part="XPIN9" gate="." x="17.78" y="33.02"/>
<instance part="XPIN10" gate="." x="17.78" y="30.48"/>
<instance part="XPIN11" gate="." x="17.78" y="25.4"/>
</instances>
<busses>
</busses>
<nets>
...
<parts>
<part name="R1" library="rcl" deviceset="R-EU_" device="R0402" value="130R">
<attribute name="SPICE_VALUE" value="{2*zeta/sqrt(cval(fc,lval)/lval)}"/>
</part>
<part name="C1" library="rcl" deviceset="C-EU" device="C0402" value="2.5uF">
<attribute name="SPICE_VALUE" value="{cval(fc,lval)}"/>
</part>
<part name="L1" library="rcl" deviceset="L-EU" device="0204/5" value="10mH">
<attribute name="SPICE_VALUE" value="{lval}"/>
</part>
<part name="GND1" library="supply1" deviceset="GND" device=""/>
<part name="LPF1" library="ngspice" deviceset="SPICE-PORT" device="" value="LPFIN"/>
<part name="LPF2" library="ngspice" deviceset="SPICE-PORT" device="" value="LPFOUT"/>
<part name="SPARAM1" library="ngspice" deviceset="SPICE-PARAM" device="" value="{lval}=10mH"/>
<part name="SPARAM2" library="ngspice" deviceset="SPICE-PARAM" device="" value="{zeta}=1.05"/>
<part name="SPARAM3" library="ngspice" deviceset="SPICE-PARAM" device="" value="{fc}=1e3"/>
<part name="A1" library="ngspice" deviceset="DAC_BUF" device=""/>
<part name="PRS1" library="ngspice" deviceset="SPICE-PORT" device="" value="LPFIN"/>
<part name="A2" library="ngspice" deviceset="OSC" device="">
<attribute name="SP_FREQ_ARRAY" value="[1MEG 1MEG]"/>
</part>
<part name="GND2" library="supply1" deviceset="GND" device=""/>
<part name="A3" library="ngspice" deviceset="DFF" device=""/>
<part name="A4" library="ngspice" deviceset="PUP" device=""/>
<part name="A5" library="ngspice" deviceset="DSOURCE8" device="">
<attribute name="SPICE_PORTS" value="[ 8 7 6 5 4 3 2 1 ]"/>
<attribute name="SP_INPUT_FILE" value="&quot;../sine.ssv&quot;"/>
</part>
</parts>
<sheets>
<sheet>
<plain>
<text x="10.16" y="33.02" size="1.778" layer="100">.func cval(fc,lval) {1/(lval*(6.28*fc)^2)}</text>
</plain>
<instances>
<instance part="R1" gate="G$1" x="35.56" y="58.42">
<attribute name="SPICE_VALUE" x="31.496" y="63.246" size="1.778" layer="96"/>
</instance>
<instance part="C1" gate="G$1" x="60.96" y="53.34">
<attribute name="SPICE_VALUE" x="63.5" y="45.72" size="1.778" layer="96" display="both"/>
</instance>
<instance part="L1" gate="G$1" x="50.8" y="58.42" rot="MR270">
<attribute name="SPICE_VALUE" x="48.26" y="53.34" size="1.778" layer="96" rot="MR180"/>
</instance>
<instance part="GND1" gate="1" x="60.96" y="43.18"/>
<instance part="LPF1" gate="." x="22.86" y="58.42" rot="MR0"/>
<instance part="LPF2" gate="." x="76.2" y="58.42"/>
<instance part="SPARAM1" gate="G$1" x="10.16" y="38.1"/>
<instance part="SPARAM2" gate="G$1" x="10.16" y="43.18"/>
<instance part="SPARAM3" gate="G$1" x="10.16" y="48.26"/>
</instances>
<busses>
</busses>
<nets>
<net name="LPFOUT" class="0">
<segment>
...
<moduleinsts>
<moduleinst name="PRSGEN8" module="PRSGEN8" x="60.96" y="35.56"/>
</moduleinsts>
<instances>
<instance part="A1" gate="G$1" x="91.44" y="40.64"/>
<instance part="PRS1" gate="." x="116.84" y="40.64"/>
<instance part="A2" gate="G$1" x="-10.16" y="40.64" rot="MR180">
<attribute name="SP_FREQ_ARRAY" x="-20.32" y="50.8" size="1.778" layer="96" rot="MR180" display="both"/>
</instance>
<instance part="GND2" gate="1" x="-30.48" y="33.02"/>
<instance part="A3" gate="G$1" x="22.86" y="15.24" rot="MR180"/>
<instance part="A4" gate="G$1" x="-2.54" y="20.32"/>
<instance part="A5" gate="G$1" x="60.96" y="7.62" rot="R90">
<attribute name="SP_INPUT_FILE" x="45.72" y="-2.54" size="1.778" layer="96" display="both"/>
<attribute name="SPICE_PORTS" x="45.72" y="-5.08" size="1.778" layer="96" display="both"/>
</instance>
</instances>
<busses>
</busses>
...
<portref moduleinst="PRSGEN8" port="OUT"/>
...
<net name="GND" class="0">
<segment>
<pinref part="A2" gate="G$1" pin="VCNTL"/>
...
<segment>
<pinref part="A2" gate="G$1" pin="CLK#"/>
<portref moduleinst="PRSGEN8" port="CLK"/>
<wire x1="5.08" y1="40.64" x2="7.62" y2="40.64" width="0.1524" layer="91"/>
<pinref part="A3" gate="G$1" pin="#CLK"/>
...
<segment>
<portref moduleinst="PRSGEN8" port="RST"/>
...
<segment>
<portref moduleinst="PRSGEN8" port="CMP0"/>
<pinref part="A5" gate="G$1" pin="D0#"/>
<wire x1="53.34" y1="17.78" x2="53.34" y2="20.32" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$7" class="0">
<segment>
<portref moduleinst="PRSGEN8" port="CMP1"/>
<pinref part="A5" gate="G$1" pin="D1#"/>
<wire x1="55.88" y1="17.78" x2="55.88" y2="20.32" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$8" class="0">
<segment>
<portref moduleinst="PRSGEN8" port="CMP2"/>
<pinref part="A5" gate="G$1" pin="D2#"/>
<wire x1="58.42" y1="17.78" x2="58.42" y2="20.32" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$9" class="0">
<segment>
<portref moduleinst="PRSGEN8" port="CMP3"/>
<pinref part="A5" gate="G$1" pin="D3#"/>
<wire x1="60.96" y1="17.78" x2="60.96" y2="20.32" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$10" class="0">
<segment>
<portref moduleinst="PRSGEN8" port="CMP4"/>
<pinref part="A5" gate="G$1" pin="D4#"/>
<wire x1="63.5" y1="17.78" x2="63.5" y2="20.32" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$11" class="0">
<segment>
<portref moduleinst="PRSGEN8" port="CMP5"/>
<pinref part="A5" gate="G$1" pin="D5#"/>
<wire x1="66.04" y1="17.78" x2="66.04" y2="20.32" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$12" class="0">
<segment>
<portref moduleinst="PRSGEN8" port="CMP6"/>
<pinref part="A5" gate="G$1" pin="D6#"/>
<wire x1="68.58" y1="17.78" x2="68.58" y2="20.32" width="0.1524" layer="91"/>
</segment>
</net>
<net name="N$13" class="0">
<segment>
<portref moduleinst="PRSGEN8" port="CMP7"/>
<pinref part="A5" gate="G$1" pin="D7#"/>
